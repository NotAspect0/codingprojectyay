 ...
 * dtrobles, savvyy
 *
 * The Triangle.cpp file for the Cool Pictures project.
 */
...
Triangle::Triangle() {
    ...
    vertexTwo = ver2;
    vertexThree = ver3;
    vertexOneColor = ver1Color;
    vertexTwoColor = ver2Color;
    vertexThreeColor = ver3Color;
}

// Overloaded constructor. Sets three vertices and sets all three colors to one single color.
...
// Overloaded constructor. Sets three vertices and three colors.
